...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('namecity', models.CharField(db_index=True, max_length=20, verbose_name='город')),
                ('slug', models.SlugField(max_length=200, unique=True)),
            ],
            options={
                'verbose_name': 'Город',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagecontact', models.ImageField(blank=True, upload_to='products/%Y/%m/%d/', verbose_name='Изображение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='shop.City', verbose_name='Город')),
            ],
            options={
                'verbose_name': 'Товар',
